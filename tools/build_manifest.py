...
def write_parameter_schema() -> None:
    schema = {
        ...
        "properties": {
            ...
            "slot_width_mm": {"type": "number", "exclusiveMinimum": 0},
            "slot_spacing_mm": {"type": "number", "exclusiveMinimum": 0},
            ...
            "connector_depth_mm": {"type": "number", "exclusiveMinimum": 0},
            "flange_extra_mm": {"type": "number", "exclusiveMinimum": 0},
            ...
            "reconciliation_contract": {"type": "string"},
