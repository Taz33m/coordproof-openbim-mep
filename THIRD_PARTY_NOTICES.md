...
| pytest | Runtime assertion rewriting used by IfcOpenShell's EXPRESS-rule validator | MIT; <https://pytest.org/> |
| bcf-client | Optional BCF 3.0 issue-package writer | GPL-3.0; <https://pypi.org/project/bcf-client/> |
